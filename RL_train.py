...
def eval_policy(policy, eval_env, adv_generator, eval_episodes=30):
...
if __name__ == "__main__":
	...
	parser.add_argument('--AV_traj_num', type=int,default=5)
	...
	config_train = dict(
				data_directory=os.path.join(os.path.dirname(__file__), "./raw_scenes_100"),
				...
				vehicle_config=dict(
					lidar = dict(num_lasers=30,distance=50, num_others=0),
	...
	for t in range(int(args.max_timesteps)):
		...
		if done:
			adv_generator.after_episode(update_AV_traj=True)
